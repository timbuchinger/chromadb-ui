<template>
  <div class="fixed top-4 right-4 z-50 space-y-2 min-w-[300px] max-w-[400px]">
    <transition-group name="notification" tag="div">
      <div
        v-for="notification in notifications"
        :key="notification.id"
        :class="[
          'rounded-md p-4 shadow-lg cursor-pointer transform transition-all duration-300 break-words',
          {
      ...
      >
        <div class="flex justify-between items-center">
          ...
          <button @click.stop="removeNotification(notification.id)" class="opacity-50 hover:opacity-100">
